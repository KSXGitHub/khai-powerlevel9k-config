...
export POWERLEVEL9K_HOME_SUBFOLDER_ICON=$POWERLEVEL9K_FOLDER_ICON
...
export POWERLEVEL9K_GENERIC_LINUX_ICON=$'\uF17C'
export POWERLEVEL9K_LINUX_ICON=$POWERLEVEL9K_GENERIC_LINUX_ICON
export POWERLEVEL9K_ARCHLINUX_ICON=$'\uF300'
export POWERLEVEL9K_GENTOO_ICON=$'\uF310'
export POWERLEVEL9K_DEBIAN_ICON=$'\uF302'
export POWERLEVEL9K_UBUNTU_ICON=$'\uF30D'
export POWERLEVEL9K_FEDORA_ICON=$'\uF303'
export POWERLEVEL9K_SLACKWARE_ICON=$'\uF30A'
export POWERLEVEL9K_LINUX_MINT_ICON=$'\uF304'
export POWERLEVEL9K_RHEL_ICON=$'\uE7BB'
...
export POWERLEVEL9K_REDHAT_ICON=$'\uE7BB'
...
export POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX=$POWERLEVEL9K_MULTILINE_SECOND_PROMPT_PREFIX
export POWERLEVEL9K_CUSTOM_PACKAGE_JSON_NPMVER=$(npm --version)
export POWERLEVEL9K_CUSTOM_PACKAGE_JSON_CHECK_BY_REPO=true
export POWERLEVEL9K_CUSTOM_PACKAGE_JSON_CHECK_PARENT=0
